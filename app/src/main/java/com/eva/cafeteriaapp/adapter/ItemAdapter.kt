...
class ItemAdapter (private val itemList: List<ClipData.Item>): RecyclerView.Adapter<ItemAdapter.ItemAdapterHolder>() {
    ...
    override fun onBindViewHolder(holder: ItemAdapterHolder, position: Int) {
        ...
        holder.MealDescription.text=currentItem.Description
    ...
    class ItemAdapterHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        val MealDescription: TextView = itemView.findViewById(R.id.item_meal_description)
